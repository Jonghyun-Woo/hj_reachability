"""Visualize GUAM HJ reachability results as 2D contours over all state pairs.

Each `.npy` file in `examples/guam_outputs/` holds a 4D value function on the
...
def parse_axis(stem):
    """Extracts the axis ('lon'/'lat') from a stem like 'GUAM_LON_BRT_UH19_WH3'."""
